...
export default function App() {
  ...
  const [currentPaletteName, setCurrentPaletteName] =
    useState<string>("Current Palette");
  const [showShortcuts, setShowShortcuts] = useState(false);
  const [selectedColorIndex, setSelectedColorIndex] = useState<
    number | null
  >(null);
  const [inspectorColor, setInspectorColor] = useState<
    string | null
  >(null);
  const [hasInteracted, setHasInteracted] = useState(false);
  const [workflowStep, setWorkflowStep] = useState<
    "input" | "generate" | "evaluate" | "export"
  >("input");
  const [advancedSectionsOpen, setAdvancedSectionsOpen] =
    useState({
      utilities: false,
      adjustments: false,
    });
  ...
  const handleGenerate = (colors: string[]) => {
    ...
    if (colors.length > 0) {
      ...
      setTimeout(() => {
        toast.info(
          "Ready to refine! Try different generation modes or evaluate accessibility.",
        );
      }, 500);
    }
  };
  ...
  const handleImport = (
    imported: ColorPalette | ColorPalette[],
  ) => {
  ...
  const navigateToStep = (
    step: "input" | "generate" | "evaluate" | "export",
  ) => {
    if (step === "input") {
  ...
  const currentPaletteForExport: ColorPalette | null =
  ...
  useEffect(() => {
    document.title =
      "Color Rodeo - Professional Color Palette Manager";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#151518] bg-gradient-to-br from-neutral-50 via-neutral-100 to-neutral-50 dark:from-[#151518] dark:via-[#1A1B1F] dark:to-[#151518]">
      ...
      <div className="container mx-auto px-4 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-12 max-w-[1600px]">
          ...
          <div className="relative bg-neutral-50 dark:bg-[#18191D] border-b border-neutral-200 dark:border-[#292B33] overflow-hidden">
            ...
            <div className="relative px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-16">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 mb-8 sm:mb-10 md:mb-12 rounded-full bg-white dark:bg-[#1E1F23] border border-neutral-200 dark:border-[#292B33] shadow-[inset_0_1px_0_rgba(0,0,0,0.02)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] animate-in fade-in slide-in-from-top-2 duration-700 transition-all duration-500 hover:scale-105 hover:shadow-[0_0_20px_rgba(212,168,85,0.3),inset_0_1px_0_rgba(0,0,0,0.02)] dark:hover:shadow-[0_0_20px_rgba(242,196,107,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] hover:border-[#D4A855]/30 dark:hover:border-[#F2C46B]/30 hover:-translate-y-0.5 cursor-default active:scale-100">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#D4A855] dark:bg-[#F2C46B] shadow-[0_0_6px_rgba(212,168,85,0.6)] dark:shadow-[0_0_6px_rgba(242,196,107,0.4)] animate-pulse" />
                  <span className="text-[10px] sm:text-xs tracking-wider text-neutral-600 dark:text-[#C1C4CF] uppercase">
                ...
                <div className="mb-6 sm:mb-8 md:mb-10 animate-in fade-in slide-in-from-top-4 duration-700 delay-100">
                  <h1
                    ...
                    style={{
                      ...
                      fontWeight: 400,
                      backgroundImage:
                        "linear-gradient(90deg, #EF4444, #F97316, #F59E0B, #84CC16, #10B981, #06B6D4, #3B82F6, #6366F1, #8B5CF6, #EC4899, #EF4444)",
                ...
                {/* Refined tagline */}
                <p
                  className="text-neutral-600 dark:text-[#C1C4CF] max-w-xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed mb-8 sm:mb-10 md:mb-12 tracking-wide animate-in fade-in slide-in-from-top-6 duration-700 delay-200 px-4"
                  style={{ fontWeight: 400 }}
                >
                  Professional color tools for designers and
                  developers
                </p>
          ...
          <div className="bg-white dark:bg-[#18191D] border-b border-neutral-200 dark:border-[#292B33] px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-6">
                <h2
                  className="text-base sm:text-lg md:text-xl text-neutral-900 dark:text-[#F5F5F7] mb-2"
                  style={{ fontWeight: 500 }}
                >
                  Start Your Color Journey
                </h2>
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-[#8C909A]">
                  Enter a base color or paste multiple hex codes
                  to begin
                </p>
              </div>
              ...
              <div className="mt-8">
                <div className="mb-4 text-center">
                  <h3
                    className="text-sm text-neutral-700 dark:text-[#C1C4CF] mb-1"
                    style={{ fontWeight: 500 }}
                  >
                ...
                <PalettePresets
                  onLoadPreset={handleLoadPalette}
                />
              </div>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            {currentPalette.length === 0 &&
              ...
              workflowStep === "input" && (
                <div className="mb-8 p-6 sm:p-8 bg-gradient-to-br from-amber-500/5 to-cyan-500/5 border border-amber-500/20 rounded-2xl text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <h3
                    className="text-lg text-neutral-700 dark:text-neutral-300 mb-2"
                    style={{ fontWeight: 500 }}
                  >
                    Let's Create Something Beautiful
                  </h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 max-w-md mx-auto leading-relaxed">
                    Enter a base color above, choose a preset
                    palette, or paste multiple hex codes to get
                    started with your color journey.
                  </p>
                </div>
              )}
              ...
              currentPalette.length === 0 && (
                <div className="mb-8 p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-center">
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    <strong>Step 1: Input</strong> - Start by
                    entering a base color or choosing a preset
                    above
                  </p>
                </div>
              )}
              ...
              currentPalette.length > 0 && (
                <div className="mb-8 p-4 bg-purple-500/5 border border-purple-500/20 rounded-xl text-center">
                  <p className="text-sm text-purple-600 dark:text-purple-400">
                    <strong>Step 2: Generate</strong> - Refine
                    your palette using harmony rules, gradients,
                    or scales below
                  </p>
                </div>
              )}
              ...
              currentPalette.length > 0 && (
                <div className="mb-8 p-4 bg-green-500/5 border border-green-500/20 rounded-xl text-center">
                  <p className="text-sm text-green-600 dark:text-green-400">
                    <strong>Step 3: Evaluate</strong> - Review
                    accessibility scores and contrast ratios on
                    the right
                  </p>
                </div>
              )}
              ...
              currentPalette.length > 0 && (
                <div className="mb-8 p-4 bg-amber-500/5 border border-amber-500/20 rounded-xl text-center">
                  <p className="text-sm text-amber-600 dark:text-amber-400">
                    <strong>Step 4: Export</strong> - Scroll
                    down to export your palette in various
                    formats
                  </p>
                </div>
              )}
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div
                  className={
                    workflowStep === "input"
                      ? "ring-2 ring-[#F2C46B]/30 rounded-2xl p-4"
                      : ""
                  }
                >
                  <div className="mb-4">
                    <h3
                      className="text-neutral-900 dark:text-[#F5F5F7] mb-1"
                      style={{ fontWeight: 500 }}
                    >
                      Your Palette
                      {workflowStep === "input" && (
                        <span className="ml-2 text-xs text-[#D4A855] dark:text-[#F2C46B]">
                          ← Start here
                        </span>
                      )}
                    </h3>
                ...
                >
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-neutral-500 dark:text-[#8C909A]">
                      Create palettes using different color
                      theories
                    </p>
                  </div>
                  <Tabs
                  ...
                  >
                    <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 bg-neutral-100 dark:bg-[#1E1F23] h-auto p-1 rounded-xl">
                      <TabsTrigger
                        value="generate"
                        className="min-h-[40px] text-xs rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-[#23252B] data-[state=active]:shadow-sm"
                      >
                        Generate
                      </TabsTrigger>
                      <TabsTrigger
              ...
              <div className="space-y-8">
                ...
                >
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-neutral-500 dark:text-[#8C909A]">
                      Intelligent recommendations to maximize
                      accessibility
                    </p>
                  </div>
                  <PaletteOptimizer
                ...
                >
                  <Collapsible defaultOpen={true}>
                    <CollapsibleTrigger
                      className="flex items-center justify-between w-full px-4 py-3 bg-neutral-100 dark:bg-[#1E1F23] rounded-xl text-sm text-neutral-700 dark:text-[#C1C4CF] hover:bg-neutral-200 dark:hover:bg-[#23252B] transition-all duration-300 group"
                      style={{ fontWeight: 500 }}
                    >
                      <div className="flex items-center gap-2">
                        <span>Contrast Matrix</span>
                        <span
                          className="text-xs text-neutral-500 dark:text-[#8C909A]"
                          style={{ fontWeight: 400 }}
                        >
                ...
                <div>
                  <Collapsible
                    open={advancedSectionsOpen.adjustments}
                    onOpenChange={(open) =>
                ...
                <div>
                  <Collapsible
                    open={advancedSectionsOpen.utilities}
                    onOpenChange={(open) =>
                      setAdvancedSectionsOpen({
                        ...advancedSectionsOpen,
                        utilities: open,
            ...
            <div className="mt-12 pt-12 border-t border-neutral-200 dark:border-[#292B33]">
              <div className="text-center mb-8">
                <h2
                  className="text-neutral-900 dark:text-[#F5F5F7] mb-2"
                  style={{ fontWeight: 500 }}
                >
                  Color Inspiration
                </h2>
                <p className="text-sm text-neutral-600 dark:text-[#8C909A]">
                  Explore trending, seasonal, and professional
                  color palettes
                </p>
              </div>
            ...
            {/* ============================================ */}
            <div
              className={`mt-12 pt-12 border-t border-neutral-200 dark:border-[#292B33] ${
                workflowStep === "export"
                  ? "ring-2 ring-[#F2C46B]/30 rounded-2xl p-6 -m-6"
                  : ""
              }`}
            >
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-neutral-600 dark:text-[#8C909A]">
                  Export your palette in multiple formats or
              ...
              <div className="max-w-4xl mx-auto">
                <Tabs defaultValue="basic" className="w-full">
                  <TabsList className="grid w-full grid-cols-2 bg-neutral-100 dark:bg-[#1E1F23] h-auto p-1 rounded-xl max-w-md mx-auto mb-6">
                    <TabsTrigger
                      value="basic"
                      className="min-h-[44px] text-sm rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-[#23252B] data-[state=active]:shadow-sm"
                    >
                      Basic Export
                    </TabsTrigger>
                    <TabsTrigger
        ...
        {showShortcuts && (
          ...
          >
            <div
              className="w-full max-w-md p-6 sm:p-8 bg-white dark:bg-[#18191D] rounded-2xl border border-neutral-200 dark:border-[#292B33] shadow-[0_0_0_1px_rgba(0,0,0,0.03),0_20px_60px_rgba(0,0,0,0.2)] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_20px_60px_rgba(0,0,0,0.5)] text-left animate-in slide-in-from-bottom-4 duration-300"
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3
                    className="text-lg text-neutral-900 dark:text-[#F5F5F7] tracking-wide"
                    style={{ fontWeight: 500 }}
                  >
                    Keyboard Shortcuts
                  </h3>
              ...
              <div className="space-y-2 text-sm">
                {shortcuts
                  .filter(
                    (s) => s.description !== "Close panels",
                  )
                  .map((shortcut, idx) => (
                    <div
                      key={idx}
                      className="flex justify-between items-center gap-4 group py-2.5 px-3 rounded-lg hover:bg-neutral-50 dark:hover:bg-[#23252B] transition-all duration-200"
                    >
              ...
              <div className="mt-6 p-3 bg-[#F2C46B]/5 border border-[#F2C46B]/15 rounded-lg flex items-start gap-3">
                ...
                <p className="text-xs text-neutral-600 dark:text-[#8C909A] leading-relaxed">
                  Press{" "}
                  <code className="px-1.5 py-0.5 bg-neutral-100 dark:bg-[#23252B] rounded text-[#D4A855] dark:text-[#F2C46B]">
                    Esc
                  </code>{" "}
                  to close open panels and dialogs
                </p>
              </div>
            </div>
          </div>
